...
int main(int argc, const char * argv[]) {
	...
	string ou_ext = "lzn3";
	const int dict_size =  2 * 1024 * 1024;
	const int a = 1074200, b = a + 1500;
	...
	lzns_deflate<dict_size, false, a, b> deflate(
	...
	lzns_inflate<dict_size, false, a, b, true> inflate(
		"/Users/hephaestus/Desktop/test_files/" + file + ou_ext,
